...
import saeeshkadge.com.moneymanager.adapter.DrawerListViewAdapter;
import saeeshkadge.com.moneymanager.adapter.HomeViewPagerAdapter;
import saeeshkadge.com.moneymanager.notification.FillExpenseNotificationScheduler;
import saeeshkadge.com.moneymanager.presenter.NavigationDrawerPresenter;
...
public class MainActivity extends FragmentActivity implements NavigationDrawerItemView, ActionBar.TabListener {
  ...
  private void onDrawerItemSelected() {
    ...
    final saeeshkadge.com.moneymanager.presenter.NavigationDrawerPresenter navigationDrawerPresenter = new NavigationDrawerPresenter(this);
  ...
  private void addTabs() {
    ...
    addNewExpenseTab.setText("Add Expense");
    actionBar.addTab(addNewExpenseTab);

    ActionBar.Tab todayTab = actionBar.newTab();
    todayTab.setTabListener(this);
    todayTab.setText("Todays Expenses");
    actionBar.addTab(todayTab);

    ActionBar.Tab addNewSavingTab = actionBar.newTab();
    addNewSavingTab.setTabListener(this);
    addNewSavingTab.setText("Add Savings");
    actionBar.addTab(addNewSavingTab);
  }
